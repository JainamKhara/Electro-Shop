...
<div class="product-detail-container" style="max-width: 1400px; margin: 4rem auto; display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 8rem; padding: 0 4rem;">
    ...
    <div class="product-content" style="display: flex; flex-direction: column; justify-content: center;">
        <div style="display: flex; gap: 1rem; align-items: center; margin-bottom: 2rem;">
            <span style="color: var(--primary); font-weight: 800; text-transform: uppercase; letter-spacing: 0.3em; font-size: 0.7rem;"><%= l.getBname() %> // ENGINEERING UNIT</span>
        ...
        <div style="margin-top: 2rem;">
            <a href='addtocartnull?id=<%=l.getBname()%>&ie=<%=l.getCname()%>&ig=<%=l.getPname() %>&ih=<%=l.getPprice()%>&ii=<%=l.getPquantity()%>&ij=<%=l.getPimage()%>' 
